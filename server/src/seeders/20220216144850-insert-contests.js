...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    const generateContest = key => ({
      ...
      prize: 100,
      createdAt: _.sample([
        '2022-12-25 12:00:00+00',
        '2022-12-27 12:00:00+00',
        '2022-12-30 12:00:00+00',
        '2022-12-31 12:00:00+00',
        '2023-01-03 12:00:00+00',
        '2023-01-09 12:00:00+00',
        '2023-01-14 12:00:00+00',
        '2023-01-24 12:00:00+00',
        '2023-02-02 12:00:00+00',
        '2023-02-05 12:00:00+00',
      ]),
      priority: 1,
      orderId: uuid(),
